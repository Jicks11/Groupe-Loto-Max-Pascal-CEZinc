...
- Deduction automatique prevue les jeudis et dimanches, soit le lendemain des tirages mercredi/samedi.
...
Cloudflare affichera une URL `https://...trycloudflare.com`. Ouvrir cette URL sur le telephone, avec `/loto-max/` a la fin si necessaire.
